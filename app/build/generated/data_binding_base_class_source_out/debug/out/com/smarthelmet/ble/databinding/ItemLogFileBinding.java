...
public final class ItemLogFileBinding implements ViewBinding {
  ...
  private ItemLogFileBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvFileName,
  ...
  public static ItemLogFileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemLogFileBinding((MaterialCardView) rootView, tvFileName, tvFileSize);
    }
